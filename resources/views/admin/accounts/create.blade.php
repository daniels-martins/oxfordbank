          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-content collapse show">
                <div class="card-body">
                  <form action="{{ route('accounts.store') }}" method="post" class="steps-validation wizard-notification wizard-info">
                    @csrf
                    <!----   Step 2 ------>
                    <h6>
                      Account Type
                            ...
                            <div class="row skin skin-flat">
                              <div class="col-md-12">
                                <div class="form-check">
                                  <input id="savings" name="aza_type" type="radio" value="savings" checked>
                                  <label for="savings">
                                    Savings
                                  </label>
                                </div>
                                <div class="form-check">
                                  <input id="checking" name="aza_type" type="radio" value="checking">
                                  <label for="checking">
                                    Checking
                                  </label>
                                </div>
                                ...
                                <div class="form-check">
                                  <input id="loan" name="aza_type" type="radio" value="loan" >
                                  <label for="loan">
                                    Loan
                                  </label>
                                </div>
                                ...
                                <div class="form-check">
                                  <input id="joint" name="aza_type" type="radio" value="joint">
                                  <label for="joint">
                                    Joint
                                  </label>
                                </div>
